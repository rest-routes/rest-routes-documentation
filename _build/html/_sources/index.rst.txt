...
This feature will allow you to conditionally display some field in the output of several endpoint types, such as: Posts Display,
Taxonomies Display, Users Display, and Custom Table Display.

As soon as you add some field in the output of a endpoint, you will see a section called "Conditional Display".
The next step is to add at least one `custom parameter`_. As a last step you will have to fill the 3 fields accordingly:
...
only if the value of "show_prices" is equals to "yes". Then this is what you have to do:
...
notify a third party service when certain action is done.
...
In Request body you can compose the body of the request as you wish.
...
- Normal field: where you can add as many fields as you wish in order to be rendered as output of you request after the extra request is done.
- Request response: the response of the extra request will be displayed in the output.

Custom SQL Query
+++++++++++++++++

.. warning:: This is a dangerous endpoint type! You must be sure of what you are doing. This endpoint will let you update both single and a range of entries from any kind of database table, even default WordPress ones. So, pay attention to the query you are writing, you may turn your site completely unusable when using wrong queries.
